.. IntroGM documentation master file, created by
   sphinx-quickstart on Mon Dec 12 12:01:23 2016.
...
.. topic:: Exercise
   ...
   differences is visualized in Fig X.
...
.. topic:: Exercise
   ...
   lines (l. 63 and l. 74) so that the next elevation will be calculated.

   Once the code works, vary the number of time steps and the size
   of the time step, and compare the results to the given analyrical 
   solution.
