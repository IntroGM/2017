...
.. math::
   ...
   \frac{T_{n+1}^{i-1} - 2T_n^{i-1} + T_{n-1}^{i-1}}{\Delta x^2} + H
...
.. math::
   \rho C_p \frac{T_n^{i} - T_n^{i-1}}{\Delta t} = 
   \frac{T_{n+1}^i - 2T_n^i + T_{n-1}^i}{\Delta x^2} + H
...
.. math::
   T_{n-1}^i \left(\frac{-k}{\Delta x^2}\right) +
   T_n^i \left(\frac{\rho C_p}{\Delta t} + \frac{2k}{\Delta x^2}\right) +
   T_{n+1}^i \left(\frac{-k}{\Delta x^2}\right) 
...
:math:`A=-k/\Delta x^2` and :math:`B=\frac{\rho C_p}{\Delta t} + \frac{2k}{\Delta x^2}`,
we can write 
